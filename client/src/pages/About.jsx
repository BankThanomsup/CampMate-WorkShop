      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl p-6 h-48 flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="text-3xl mb-2">🏕️</div>
                    <p className="text-sm font-medium">แคมปิ้งริมทะเล</p>
                  </div>
                </div>
                <div className="bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl p-6 h-32 flex items-center justify-center">
                  <div className="text-center text-white">
              ...
              <div className="space-y-4 pt-8">
                <div className="bg-gradient-to-br from-orange-400 to-red-500 rounded-2xl p-6 h-32 flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="text-2xl mb-1">⭐</div>
                    <p className="text-xs font-medium">รีวิวจริง</p>
                  </div>
                </div>
                <div className="bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl p-6 h-48 flex items-center justify-center">
                  <div className="text-center text-white">
                    <div className="text-3xl mb-2">🗺️</div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-6">
            <h3 className="text-3xl font-bold text-purple-600 mb-2">🏞️</h3>
            <p className="text-gray-600">สถานที่แคมปิ้งมากมาย</p>
          </div>
          <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-6">
            <h3 className="text-3xl font-bold text-blue-600 mb-2">⚡</h3>
            <p className="text-gray-600">การจองที่รวดเร็ว</p>
          </div>
          <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-6">
            <h3 className="text-3xl font-bold text-green-600 mb-2">✅</h3>
            <p className="text-gray-600">ตรวจสอบความถูกต้องการจอง</p>
          </div>
        </div>
