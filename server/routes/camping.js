...
// @ENDPOINT http://localhost:5000/api/camping/1/user-bookings
// @METHOD GET [get user's bookings for specific camping]
// @ACCESS private
router.get("/camping/:id/user-bookings", authCheck, getUserCampingBookings);
